...
def create_app() -> Flask:
    ...
    def users_page():
        ...
        if q:
            # Регістронезалежний пошук - ВИПРАВЛЕНО
            search_fields = []
    ...
    @login_required
    def users_export():
        """Експорт користувачів у CSV - ДОДАНО"""
        import csv
    ...
    @login_required
    def api_db_check():
        """Перевірка БД - ДІАГНОСТИКА СИНХРОНІЗАЦІЇ"""

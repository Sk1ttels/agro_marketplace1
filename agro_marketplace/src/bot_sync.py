...
async def main():
    ...
    # Підключення BanCheckMiddleware
    ...
    try:
        # КРИТИЧНО: Видалення webhook перед запуском polling
        await bot.delete_webhook(drop_pending_updates=True)
        logger.info("✅ Webhook видалено, очікуємо стабілізації...")
        ...
        await dp.start_polling(
            ...
            handle_signals=False  # Не обробляємо сигнали тут
        )
